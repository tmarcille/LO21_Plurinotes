...
Tache::Tache(const QString& i, const QString& folder, const QString& ti, const QString& a="", const QDate &d=QDate(0,0,0), const QString &p="0", const QString &s="") : Note(i,ti,folder), action(a), echeance(d), priorite(p.toInt()), status(s)
