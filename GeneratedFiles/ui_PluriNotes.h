...
public:
    ...
    {
        PluriNotesClass->setWindowTitle(QApplication::translate("PluriNotesClass", "PluriNotes", 0));
        actionNote->setText(QApplication::translate("PluriNotesClass", "Note", 0));
        actionOuvrir->setText(QApplication::translate("PluriNotesClass", "Ouvrir...", 0));
        menuFichier->setTitle(QApplication::translate("PluriNotesClass", "Fichiers", 0));
        menuNouveau->setTitle(QApplication::translate("PluriNotesClass", "Nouveau", 0));
        menuEdition->setTitle(QApplication::translate("PluriNotesClass", "Edition", 0));
        toolBar->setWindowTitle(QApplication::translate("PluriNotesClass", "toolBar", 0));
    } // retranslateUi
