...
void NouvelleNote::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NouvelleNote *_t = static_cast<NouvelleNote *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject NouvelleNote::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_NouvelleNote.data,
      qt_meta_data_NouvelleNote,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NouvelleNote::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NouvelleNote.stringdata0))
        return static_cast<void*>(const_cast< NouvelleNote*>(this));
